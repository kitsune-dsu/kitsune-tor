...
static token_rule_t routerdesc_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
...
static token_rule_t extrainfo_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
  T1_END( "router-signature",    K_ROUTER_SIGNATURE,    NO_ARGS, NEED_OBJ ),
  T1( "published",           K_PUBLISHED,       CONCAT_ARGS, NO_OBJ ),
  T0N("opt",                 K_OPT,             CONCAT_ARGS, OBJ_OK ),
  T01("read-history",        K_READ_HISTORY,        ARGS,    NO_OBJ ),
 ...
 * documents. */
static token_rule_t rtrstatus_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
 ...
 */
static token_rule_t netstatus_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
  T1( "published",           K_PUBLISHED,       CONCAT_ARGS, NO_OBJ ),
  T0N("opt",                 K_OPT,             CONCAT_ARGS, OBJ_OK ),
 ...
 * footers. */
static token_rule_t dir_footer_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
  T1("directory-signature", K_DIRECTORY_SIGNATURE, EQ(1), NEED_OBJ ),
  END_OF_TABLE
};

/** List of tokens allowable in v1 directory headers/footers. */
static token_rule_t dir_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
...
static token_rule_t dir_key_certificate_table[] E_MANUAL_MIGRATE = { /**DSU data */
  CERTIFICATE_MEMBERS
  T1("fingerprint",      K_FINGERPRINT,              CONCAT_ARGS, NO_OBJ ),
  END_OF_TABLE
};
...
static token_rule_t desc_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
...
static token_rule_t ipo_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
...
static token_rule_t client_keys_token_table[] E_MANUAL_MIGRATE= { /**DSU data */
...
static token_rule_t networkstatus_token_table[] E_MANUAL_MIGRATE= { /**DSU data */
...
static token_rule_t networkstatus_consensus_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
  T1("network-status-version", K_NETWORK_STATUS_VERSION,
                                                   GE(1),       NO_OBJ ),
  T1("vote-status",            K_VOTE_STATUS,      GE(1),       NO_OBJ ),
  T1("valid-after",            K_VALID_AFTER,      CONCAT_ARGS, NO_OBJ ),
...
/** List of tokens allowable in the footer of v1/v2 directory/networkstatus
 * footers. */
static token_rule_t networkstatus_vote_footer_token_table[] E_MANUAL_MIGRATE = { /**DSU data */
  T(  "directory-signature", K_DIRECTORY_SIGNATURE, GE(2),   NEED_OBJ ),
  END_OF_TABLE
};

/** List of tokens allowable in detached networkstatus signature documents. */
static token_rule_t networkstatus_detached_signature_token_table[] E_MANUAL_MIGRATE= { /**DSU data */
