...
static config_abbrev_t _option_abbrevs[] E_MANUAL_MIGRATE = { /**DSU data */
  PLURAL(ExitNode),
  PLURAL(EntryNode),
  PLURAL(ExcludeNode),
  PLURAL(FirewallPort),
...
static config_abbrev_t _state_abbrevs[] E_MANUAL_MIGRATE = { /**DSU data */
 ...
 * be chosen first.
 */
static config_var_t _option_vars[] E_MANUAL_MIGRATE = { /**DSU data */
  ...
  V(DoDSU,                       BOOL,     "0"), /** DSU other */
  V(DSUTarget,                   STRING,   NULL), /**DSU other */
 ...
 * option. */
static config_var_t testing_tor_network_defaults[] E_MANUAL_MIGRATE = { /**DSU data */
  V(ServerDNSAllowBrokenConfig,  BOOL,  "1"),
...
static config_var_t _state_vars[] E_MANUAL_MIGRATE = { /**DSU data */
...
static config_var_description_t options_description[] E_MANUAL_MIGRATE = { /**DSU data */
  /* ==== general options */
...
static config_var_description_t state_description[] E_MANUAL_MIGRATE = { /**DSU data */
...
static config_format_t options_format E_MANUAL_MIGRATE = { /**DSU data */
  sizeof(or_options_t),
  OR_OPTIONS_MAGIC,
...
static config_var_t state_extra_var E_MANUAL_MIGRATE = { /**DSU data */
  "__extra", CONFIG_TYPE_LINELIST, STRUCT_OFFSET(or_state_t, ExtraLines), NULL
};

/** Configuration format for or_state_t. */
static config_format_t state_format E_MANUAL_MIGRATE = { /**DSU data */
  sizeof(or_state_t),
  OR_STATE_MAGIC,
...
static char *_version E_MANUAL_MIGRATE = NULL; /**DSU data */
...
options_act_reversible(or_options_t *old_options, char **msg)
{
  ...
  if (kitsune_is_updating())     /**DSU control 2 */
    return 0;
 ...
 * contain. */
static struct unit_table_t memory_units[] E_MANUAL_MIGRATE = { /**DSU data */
  { "",          1 },
  { "b",         1<< 0 },
  { "byte",      1<< 0 },
  { "bytes",     1<< 0 },
 ...
 * contain. */
static struct unit_table_t time_units[] E_MANUAL_MIGRATE = { /**DSU data */
  { "",         1 },
  { "second",   1 },
  { "seconds",  1 },
  { "minute",   60 },
